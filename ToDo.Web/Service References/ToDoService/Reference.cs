...
namespace ToDo.Web.ToDoService {
    ...
    public partial class ToDoItemContract : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ParentTaskTitleField;
        ...
        public string ParentTaskId {
            ...
            set {
                if ((object.ReferenceEquals(this.ParentTaskIdField, value) != true)) {
        ...
        public string ParentTaskTitle {
            get {
                return this.ParentTaskTitleField;
            }
            set {
                if ((object.ReferenceEquals(this.ParentTaskTitleField, value) != true)) {
                    this.ParentTaskTitleField = value;
                    this.RaisePropertyChanged("ParentTaskTitle");
                }
            }
        }
    ...
    public interface IToDoService {
        ...
        ToDo.Web.ToDoService.ToDoItemContract[] GetToDoItems(string idFilter);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IToDoServiceChannel : ToDo.Web.ToDoService.IToDoService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ToDoServiceClient : System.ServiceModel.ClientBase<ToDo.Web.ToDoService.IToDoService>, ToDo.Web.ToDoService.IToDoService {
        ...
        public ToDo.Web.ToDoService.ToDoItemContract[] GetToDoItems(string idFilter) {
